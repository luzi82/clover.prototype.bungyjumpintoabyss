...
import clover.android.adb_shell as adb_shell

FFMPEG_EXEC_PATH = '/usr/bin/ffmpeg'
ADB_EXEC_PATH = '/usr/bin/adb'
APP_DISPLAY_SIZE = 400, 255
VIDEO_SIZE = 320, 180
WHITE = 255,255,255
    ...
    def logic_run(self):
        try:
            ...
            while self.run:
                ...
                if logic_result and 'tap_list' in logic_result:
                    for pos in logic_result['tap_list']:
                        self.adb_shell.input_tap(pos[0],pos[1])
        except:
            traceback.print_exc()
